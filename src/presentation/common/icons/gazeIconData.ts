export type GazeIconType = 'chat' | 'close-call' | 'video-on' | 'video-off' | 'mic-on' | 'mic-off' | 'screen-share-on' | 'screen-share-off' | 'settings' | 'send' | 'right-arrow' | 'arrow';
